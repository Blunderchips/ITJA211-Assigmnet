...
public class SearchDialog extends JDialog implements ActionListener {
    ...
    public SearchDialog(Frame parent) {
        super(parent, "What you you like to search for?", true);
        //super.setUndecorated(true);

        this.selection = null;

        this.btnStudent = new JButton("Search for a student");
        this.btnBook = new JButton("Search for a book");
        this.btnBooking = new JButton("Search for a booking");
